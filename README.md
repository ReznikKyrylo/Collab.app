...
When application starts your DB will be filled data from data.sql file from resources112323d folder
...
User with Admin role has access to all data and resources112323d in DB
